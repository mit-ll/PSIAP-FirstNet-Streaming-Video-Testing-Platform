...
public class MediaSurfaceRenderer implements GLSurfaceView.Renderer
{
    private static final String TAG = MediaSurfaceRenderer.class.getSimpleName();
    ...
    public MediaSurfaceRenderer(CameraHandler cameraHandler,
