...
import io.antmedia.android.broadcaster.IVideoBroadcaster;
import io.antmedia.android.broadcaster.VideoBroadcaster;
import io.antmedia.android.broadcaster.utils.Resolution;

public class VideoBroadcasterActivity extends AppCompatActivity
{
    private static final String TAG = VideoBroadcasterActivity.class.getSimpleName();
...
//    private CameraResolutionsFragment mCameraResolutionsDialog;
    ...
    private IVideoBroadcaster mLiveVideoBroadcaster;
    private Button mBroadcastControlButton;

    private static String RTMP_URL = null;
    ...
    private ServiceConnection mConnection = new ServiceConnection()
    {
                                       ...
                                       IBinder service)
        {
            ...
            VideoBroadcaster.LocalBinder binder = (VideoBroadcaster.LocalBinder) service;
            if (mLiveVideoBroadcaster == null) {
                mLiveVideoBroadcaster = binder.getService();
                mLiveVideoBroadcaster.init(VideoBroadcasterActivity.this, mGLView,
                        FILEPATH);
                mLiveVideoBroadcaster.setAdaptiveStreaming(true);

            }
            mLiveVideoBroadcaster.openCamera();
        }
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        Intent i = getIntent();
        final String filepath = i.getStringExtra(getString(R.string.key_media_filepath));
        final String rtmp_url = i.getStringExtra(getString(R.string.key_rtmp));
        ...
        mLiveVideoBroadcasterServiceIntent = new Intent(this, VideoBroadcaster.class);
        //this makes service do its job until done
        startService(mLiveVideoBroadcasterServiceIntent);
        Log.i(TAG, "Started service intent");

        setContentView(R.layout.layout_broadcaster);
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        switch (requestCode) {
            case VideoBroadcaster.PERMISSIONS_REQUEST: {
                if (mLiveVideoBroadcaster.isPermissionGranted()) {
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                        ...
                        new AlertDialog.Builder(VideoBroadcasterActivity.this)
...
//        }
    ...
    public void toggleBroadcasting(View v) {
        Log.i(TAG, "Triggering broadcasting");

        if (!mIsRecording) {
            if (mLiveVideoBroadcaster != null) {
                if (!mLiveVideoBroadcaster.isConnected() && RTMP_URL != null && FILEPATH != null)
                {
                    new AsyncTask<String, String, Boolean>() {
                        ...
                        protected void onPreExecute() {
                            progressBar = new ContentLoadingProgressBar(VideoBroadcasterActivity.this);
                            progressBar.show();
                        }
                        ...
                        protected void onPostExecute(Boolean result) {
                            ...
                            if (result) {
                                ...
                                Log.w(TAG, "Failed to start broadcasting");
