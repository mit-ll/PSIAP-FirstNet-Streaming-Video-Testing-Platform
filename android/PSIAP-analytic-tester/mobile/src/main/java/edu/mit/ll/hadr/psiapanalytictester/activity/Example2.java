...
import edu.mit.ll.hadr.psiapanalytictester.R;

public class Example2 extends Activity implements OnClickListener, Session.Callback, SurfaceHolder.Callback
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.example2_activity);
    ...
    private void logError(final String msg) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Example2.this);
