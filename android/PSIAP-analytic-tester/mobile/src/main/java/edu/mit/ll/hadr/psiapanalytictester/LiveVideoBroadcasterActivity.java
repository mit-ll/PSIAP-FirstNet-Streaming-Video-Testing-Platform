...
public class LiveVideoBroadcasterActivity extends AppCompatActivity {
    ...
    public LiveVideoBroadcasterActivity.TimerHandler mTimerHandler;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        mTimerHandler = new LiveVideoBroadcasterActivity.TimerHandler();
...
//        }
    ...
    public void toggleBroadcasting(View v) {
        ...
        if (!mIsRecording) {
            if (mLiveVideoBroadcaster != null) {
                if (!mLiveVideoBroadcaster.isConnected() && RTMP_URL != null)
                {
    ...
    public void startTimer() {
        ...
        mTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                mTimerHandler.obtainMessage(LiveVideoBroadcasterActivity.TimerHandler.INCREASE_TIMER).sendToTarget();

                if (mLiveVideoBroadcaster == null || !mLiveVideoBroadcaster.isConnected()) {
                    mTimerHandler.obtainMessage(LiveVideoBroadcasterActivity.TimerHandler.CONNECTION_LOST).sendToTarget();
                }
            }
        }, 0, 1000);
    }
